  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-md-9 col-lg-6 col-xl-5">
        <img src="./public/images/logoProvisional.png"
          class="img-fluid" alt="Sample image">
      </div>
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form id="form_login" action="./app/controllers/LoginController.php" method="post" >
          ...
          <div class="form-outline mb-4">
            <input type="email" id="user" class="form-control form-control-lg"
              placeholder="Ingrese su usuario" name="user"/>
